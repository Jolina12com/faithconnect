    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <h1 class="page-title text-dark">Add New Donation</h1>
                    </div>
                ...
                <div class="donation-card">
                    ...
                    <form action="{{ route('admin.donations.store') }}" method="POST" id="donationForm" class="donation-form">
                        @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-wrapper">
                                            <input type="text" name="receipt_number" id="receipt_number" 
                                                class="form-control" placeholder="RCP-001">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <textarea name="notes" id="notes" rows="3" class="form-control" 
                                        placeholder="Share any additional details about this donation...">{{ old('notes') }}</textarea>
...
$(document).ready(function() {
    ...
    $('#donation_input').autocomplete({
        source: function(request, response) {
            ...
            // Quick local search in donation types
            ...
            if (itemsCache[term] && now < cacheExpiry) {
                ...
                response(suggestions.slice(0, 10)); // Limit results
                return;
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    response(suggestions.slice(0, 10)); // Limit to 10 results
                }
            });
        },
        minLength: 1,
    ...
    // Detect donation type based on item name
        ...
        source: function(request, response) {
            ...
            donorSearchTimeout = setTimeout(() => {
                $.ajax({
                    ...
                    success: function(data) {
                        response(data.slice(0, 8)); // Limit results
                    }
                });
            }, 150);
        },
